...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        @can('add', app($dataType->model_name))
            <div class="btn btn-success btn-add-new" id="parseBtn">
                <i class="voyager-plus"></i><span>{{ __('parser.renew') }}</span>
            </div>
        @endcan
...
@section('javascript')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            document.querySelector('#parseBtn')?.addEventListener('click', ev => {
                fetch('/admin/api/parse', { method: 'GET' })
                    .then(res => res.json())
                    .then(() => {
